# source: https://github.com/pytorch/vision/blob/master/torchvision/models/mobilenetv2.py
import torch
...
model_urls = {
    'mobilenet_v2': str(settings.PRETRAINED_PATH / 'mobilenet_v2-b0353104.pth'),
}
